  ...
  return (
    ...
    <section className="section2 communities">
            <div className="container">
                <div className="row">
                    <div className="title">
                        <h2 className="section-title mt-5"> Learn More About Tech Communities </h2>
                        <p classNameName="text mt-5">To bridge the gender imbalance, we need women like you to apply for opportunities. Start by reading through the list of opportunities available to you in tech by clicking on the images below to read about them. You can also visit <a href="https://iowastem.org/blog/what-it-means-be-woman-tech">here to read more</a></p>
                    </div>
                        ...
                        <div className="row mt-4">
                            <div className="col-md-4 col-sm-6 justify-content-around mb-3">
                                <a href="https://www.freecodecamp.org/news/what-is-front-end-development/" target="_blank">
                                    <img src="https://tse2.mm.bing.net/th?id=OIP.inc14Mc5PgXpHzdf_RaHjQHaFN&pid=Api&P=0&w=248&h=174" alt="Front End Develoment" className="img-fluid" />                                     
                                </a>
                            </div>
                            <div className="col-md-4 col-sm-6 justify-content-around mb-3">
                                <a href="https://www.upwork.com/resources/beginners-guide-back-end-development" target="_blank">
                                    <img src="https://tse4.mm.bing.net/th?id=OIP.V7ABEvSzJA-U2aUZgUG-0gHaEa&pid=Api&P=0&w=325&h=194" alt="Back End Development" className="img-fluid" />
                                </a> 
                            </div>
                            <div className="col-md-4 col-sm-6 justify-content-around mb-3">
                                <a href="https://www.geeksforgeeks.org/what-is-full-stack-development/" target="_blank">
                                    <img src="https://tse4.mm.bing.net/th?id=OIP.GF_dOBH7hPCfULtmlOl24QHaDq&pid=Api&P=0&w=355&h=200" alt="Full Stack Development" className="img-fluid" />
                                </a> 
                            </div>
                            <div className="col-md-4 col-sm-6 justify-content-around mb-3">
                                <a href="https://gryphondigitalmining.com/blog/blockchain-development/#:~:text=Blockchain%20development%20is%20a%20broad%20category%20of%20computer,the%20attention%20of%20investors%20over%20the%20past%20decade." target="_blank">
                                    <img src="https://1.bp.blogspot.com/-G_glLYLwCks/WT44Qyjl9vI/AAAAAAAAwlA/nTmBW8l-A98gqzO5ILAYCCVNG5yfk8IBgCK4B/s1600/BlockChain.jpg" alt="Block Chain" className="img-fluid" /> 
                                </a>
                            </div>
                            <div className="col-md-4 col-sm-6 justify-content-around mb-3">
                                <a href="https://www.productplan.com/glossary/product-design/" target="_blank">
                                    <img src="https://image.slidesharecdn.com/productdesign-160926122455/95/product-design-1-638.jpg?cb=1474904922" alt="Product Design" className="img-fluid" />
                                </a> 
                            </div>
                            <div className="col-md-4 col-sm-6 justify-content-around mb-3">
                                <a href="https://www.productplan.com/learn/what-is-product-management/" target="_blank">
                                    <img src="https://tse2.mm.bing.net/th?id=OIP.pzT87GqU8r1M5ywy3b-53QHaE8&pid=Api&P=0&w=355&h=200" alt="Product Management" className="img-fluid" /> 
                                </a>
                            </div>
                            <div className="col-md-4 col-sm-6 justify-content-around mb-3">
                                <a href="https://www.ibm.com/topics/cybersecurity" target="_blank">
                                    <img src="https://tse1.mm.bing.net/th?id=OIP.bKRlyPiil3Rb0hwKL1BHIwHaEn&pid=Api&P=0&w=355&h=200" alt="Cyber Security" className="img-fluid" /> 
                                </a>
                            </div>
                            <div className="col-md-4 col-sm-6 justify-content-around mb-3">
                                <a href="https://www.nist.gov/artificial-intelligence" target="_blank">
                                    <img src="https://tse4.mm.bing.net/th?id=OIP.HjY4-XDU5El6yrLcveTjZQHaEH&pid=Api&P=0&w=348&h=193" alt="Artificial Intelligence" className="img-fluid" />
                                </a>
                            </div>
                            <div className="col-md-4 col-sm-6 justify-content-around mb-3">
                                <a href="https://www.digitalauthority.me/resources/mobile-app-development-guide/" target="_blank">
                                    <img src="https://tse3.mm.bing.net/th?id=OIP.zVl0_r_fzYXIGYhEs7qB9wHaE8&pid=Api&P=0&w=259&h=173" alt="Mobile App Development" className="img-fluid" />
                                </a> 
                            </div>
                            </div>
                        </div>
